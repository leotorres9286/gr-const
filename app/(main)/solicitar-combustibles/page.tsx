...
import { ListRequestFuel } from '@/types/request-fuel';
import { CONFIG_LOCALE_DATE, LOCALE } from '@/utils/constants_format';
import { RequestFuelEnum } from '@/core/enum/request-fuel.enum';
...
const RequestFuelsPage = () => {
    ...
    const statusBodyTemplate = (rowData: ListRequestFuel) => {
        return <span className={`customer-badge status-${RequestFuelEnum[rowData.status]}`}>{rowData.status}</span>;
    };
            ...
            <div className="col-12 contain-card-full-h">
                <div className="card h-full">
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="equipment.name" header="Equipo" filter filterPlaceholder="Buscar por equipo" style={{ minWidth: '12rem', fontWeight: 'bold' }} />
                        <Column field="status" header="Estado" body={statusBodyTemplate} filter filterElement={statusFilterTemplate} style={{ minWidth: '6rem' }} />
                        <Column field="requestAt" header="Fecha" dataType="date" filter filterField="requestAt" body={requestAtBodyTemplate} style={{ minWidth: '10rem' }} />
                        <Column field="countFuel" header="Cantidad Combustible" filter style={{ minWidth: '6rem' }} />
                        <Column field="hourMeter" header="Horómetro" filter style={{ minWidth: '6rem' }} />
                        <Column field="odoMeter" header="Odómetro" filter style={{ minWidth: '6rem' }} />
                        <Column field="tankLevel" header="Nivel Tanque" filter style={{ minWidth: '6rem' }} />
